...
(setq user-full-name "Alexander Wing̴rd")
...
(custom-theme-set-faces
 ...
 '(magit-section-highlight ((t (:background "grey21"))))
 '(magit-section-title ((t (:inherit magit-header :background "dark slate blue"))))
 '(magit-item-highlight ((t (:background "gray21"))))
 '(magit-diff-removed ((t (:inherit diff-removed))))
 '(magit-diff-removed-highlight ((t (:inherit magit-diff-removed :background "gray21"))))
 '(magit-diff-added ((t (:inherit diff-added))))
 '(magit-diff-added-highlight ((t (:inherit magit-diff-added :background "gray21"))))
